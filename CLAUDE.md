...
Die App ist ausschließlich im Light Mode designed. **Kein Dark Mode, kein Theme Toggle.**

- `globals.css` definiert nur Light-Variablen (keine `.dark` Selector)
- Kein `next-themes`, kein ThemeProvider
