...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error("Web crawl error:", error instanceof Error ? error.message : "Unknown error")
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error("Crawl status error:", error instanceof Error ? error.message : "Unknown error")
